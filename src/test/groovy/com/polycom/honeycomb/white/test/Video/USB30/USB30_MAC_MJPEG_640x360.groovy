...
@Title ("USB30_MAC_MJPEG_640x360")
class USB30_MAC_MJPEG_640x360 extends SystemTestSpec{
    static final Logger LOGGER = LoggerFactory.getLogger(USB30_MAC_MJPEG_640x360.class)
    ...
    def "Format -- MJPEG_Resolution -- 640x360_Rate -- #rate" (Float rate) {
        ...
        where:
        rate << whiteMac.getSupportedFrameRates( "MJPG", "640x360")
    }
}
