...
@Title ("USB30_WIN_MJPEG_1024x576")
class USB30_WIN_MJPEG_1024x576 extends SystemTestSpec{
    static final Logger LOGGER = LoggerFactory.getLogger(USB30_WIN_MJPEG_1024x576.class)
