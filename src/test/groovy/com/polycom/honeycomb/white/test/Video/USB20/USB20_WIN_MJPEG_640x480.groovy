...
@Title ("USB20_WIN_MJPEG_640x480")
class USB20_WIN_MJPEG_640x480 extends SystemTestSpec{
    static final Logger LOGGER = LoggerFactory.getLogger(USB20_WIN_MJPEG_640x480.class)
