...
@Title ("USB30_MAC_MJPEG_720x576")
class USB30_MAC_MJPEG_720x576 extends SystemTestSpec{
    static final Logger LOGGER = LoggerFactory.getLogger(USB30_MAC_MJPEG_720x576.class)
    ...
    def "Format -- MJPEG_Resolution -- 720x576_Rate -- #rate" (Float rate) {
        ...
        where:
        rate << whiteMac.getSupportedFrameRates( "MJPG", "720x576")
    }
}
