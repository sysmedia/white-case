...
@Title ("USB20_WIN_YUY2_720x576")
class USB20_WIN_YUY2_720x576 extends SystemTestSpec{
    static final Logger LOGGER = LoggerFactory.getLogger(USB20_WIN_YUY2_720x576.class)
...
//        whiteMac.select()
    ...
    @Unroll
    def "Format -- YUY2_Resolution -- 720x576_Rate -- #rate" (Float rate) {
        when:
