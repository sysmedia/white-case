...
@Title ("USB30_MAC_NV12_1024x576")
class USB30_MAC_NV12_1024x576 extends SystemTestSpec{
    static final Logger LOGGER = LoggerFactory.getLogger(USB30_MAC_NV12_1024x576.class)
    ...
    def "Format -- NV12_Resolution -- 1024x576_Rate -- #rate" (Float rate) {
        ...
        whiteMac.startVideo("NV12", "1024x576", (int) rate)
        sleep(5000)
        ...
        where:
        rate << whiteMac.getSupportedFrameRates( "NV12", "1024x576")
    }
}
