...
@Title ("USB30_WIN_MJPEG_640x480")
class USB30_WIN_MJPEG_640x480 extends SystemTestSpec{
    static final Logger LOGGER = LoggerFactory.getLogger(USB30_WIN_MJPEG_640x480.class)
