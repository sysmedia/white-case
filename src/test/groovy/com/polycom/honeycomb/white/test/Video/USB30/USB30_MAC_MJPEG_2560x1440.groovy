...
@Title ("USB30_MAC_MJPEG_2560x1440")
class USB30_MAC_MJPEG_2560x1440 extends SystemTestSpec{
    static final Logger LOGGER = LoggerFactory.getLogger(USB30_MAC_MJPEG_2560x1440.class)
    ...
    def "Format -- MJPEG_Resolution -- 2560x1440_Rate -- #rate" (Float rate) {
        ...
        where:
        rate << whiteMac.getSupportedFrameRates( "MJPG", "2560x1440")
    }
}
