...
@Title ("USB30_WIN_YUY2_720x576")
class USB30_WIN_YUY2_720x576 extends SystemTestSpec{
    static final Logger LOGGER = LoggerFactory.getLogger(USB30_WIN_YUY2_720x576.class)
