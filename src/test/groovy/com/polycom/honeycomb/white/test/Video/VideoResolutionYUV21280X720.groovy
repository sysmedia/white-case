 ...
 */
@Title ("VideoResolutionYUV21280X720 Case")
class VideoResolutionYUV21280X720 extends SystemTestSpec{
    static final Logger LOGGER = LoggerFactory.getLogger(VideoResolutionYUV21280X720.class)
...
//        whiteMac.select()
    ...
    @Unroll
    def "Format -- YUV2_Resolution -- 1280x720_Rate -- #rate" (Float rate) {
        when:
