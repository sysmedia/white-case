...
@Title ("USB20_WIN_YUY2_1024x576")
class USB20_WIN_YUY2_1024x576 extends SystemTestSpec{
    static final Logger LOGGER = LoggerFactory.getLogger(USB20_WIN_YUY2_1024x576.class)
