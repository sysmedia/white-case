...
class USB30_MAC_YUY2_352x288 extends SystemTestSpec{
    static final Logger LOGGER = LoggerFactory.getLogger(USB30_MAC_YUY2_352x288.class)
    ...
    def "Format -- YUY2_Resolution -- 352x288_Rate -- #rate" (Float rate) {
        ...
        where:
        rate << whiteMac.getSupportedFrameRates( "YUY2", "352x288")
    }
}
