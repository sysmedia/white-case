...
@Title ("USB30_MAC_YUY2_1920x1080")
class USB30_MAC_YUY2_1920x1080 extends SystemTestSpec{
    static final Logger LOGGER = LoggerFactory.getLogger(USB30_MAC_YUY2_1920x1080.class)
    ...
    def "Format -- YUY2_Resolution -- 1920x1080_Rate -- #rate" (Float rate) {
        ...
        where:
        rate << whiteMac.getSupportedFrameRates( "YUY2", "1920x1080")
    }
}
