...
@Title ("USB30_MAC_NV12_960x540")
class USB30_MAC_NV12_960x540 extends SystemTestSpec{
    static final Logger LOGGER = LoggerFactory.getLogger(USB30_MAC_NV12_960x540.class)
    ...
    def "Format -- NV12_Resolution -- 960x540_Rate -- #rate" (Float rate) {
        ...
        whiteMac.startVideo("NV12", "960x540", (int) rate)
        sleep(5000)
        ...
        where:
        rate << whiteMac.getSupportedFrameRates( "NV12", "960x540")
    }
}
