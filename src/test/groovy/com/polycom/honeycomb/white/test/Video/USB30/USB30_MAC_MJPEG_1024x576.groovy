...
@Title ("USB30_MAC_MJPEG_1024x576")
class USB30_MAC_MJPEG_1024x576 extends SystemTestSpec{
    static final Logger LOGGER = LoggerFactory.getLogger(USB30_MAC_MJPEG_1024x576.class)
    ...
    def "Format -- MJPEG_Resolution -- 1024x576_Rate -- #rate" (Float rate) {
        ...
        where:
        rate << whiteMac.getSupportedFrameRates( "MJPG", "1024x576")
    }
}
