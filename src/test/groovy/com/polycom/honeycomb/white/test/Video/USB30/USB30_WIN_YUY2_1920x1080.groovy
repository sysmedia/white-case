...
@Title ("USB30_WIN_YUY2_1920x1080")
class USB30_WIN_YUY2_1920x1080 extends SystemTestSpec{
    static final Logger LOGGER = LoggerFactory.getLogger(USB30_WIN_YUY2_1920x1080.class)
...
//        whiteMac.select()
    ...
    @Unroll
    def "Format -- YUY2_Resolution -- 1920x1080_Rate -- #rate" (Float rate) {
        when:
