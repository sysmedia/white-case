...
@Title ("USB30_MAC_YUY2_720x576")
class USB30_MAC_YUY2_720x576 extends SystemTestSpec{
    static final Logger LOGGER = LoggerFactory.getLogger(USB30_MAC_YUY2_720x576.class)
    ...
    def "Format -- YUY2_Resolution -- 720x576_Rate -- #rate" (Float rate) {
        ...
        where:
        rate << whiteMac.getSupportedFrameRates( "YUY2", "720x576")
    }
}
