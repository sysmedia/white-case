...
@Title ("VideoResolutionYUV21920X1080 Case")
class VideoResolutionYUV21920X1080 extends SystemTestSpec{
    static final Logger LOGGER = LoggerFactory.getLogger(VideoResolutionYUV21920X1080.class)
    ...
    @Unroll
    def "Format -- YUV2_Resolution -- 1920x1080_Rate -- #rate" (Float rate) {
        when:
        LOGGER.info(String.format("Start White by rate %.1f", rate))
        whiteWin.startVideo("YUY2", "1920x1080", (int) rate)
        whiteMac.startVideo("YUY2", "1920x1080", (int) rate)
        sleep(5000)
