...
@Title ("USB30_MAC_YUY2_800x600")
class USB30_MAC_YUY2_800x600 extends SystemTestSpec{
    static final Logger LOGGER = LoggerFactory.getLogger(USB30_MAC_YUY2_800x600.class)
    ...
    def "Format -- YUY2_Resolution -- 800x600_Rate -- #rate" (Float rate) {
        ...
        where:
        rate << whiteMac.getSupportedFrameRates( "YUY2", "800x600")
    }
}
