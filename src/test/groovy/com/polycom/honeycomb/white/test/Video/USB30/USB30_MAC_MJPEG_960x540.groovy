...
@Title ("USB30_MAC_MJPEG_960x540")
class USB30_MAC_MJPEG_960x540 extends SystemTestSpec{
    static final Logger LOGGER = LoggerFactory.getLogger(USB30_MAC_MJPEG_960x540.class)
    ...
    def "Format -- MJPEG_Resolution -- 960x540_Rate -- #rate" (Float rate) {
        ...
        where:
        rate << whiteMac.getSupportedFrameRates( "MJPG", "960x540")
    }
}
