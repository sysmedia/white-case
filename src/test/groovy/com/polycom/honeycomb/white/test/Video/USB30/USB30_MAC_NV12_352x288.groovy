...
@Title ("USB30_MAC_NV12_352x288")
class USB30_MAC_NV12_352x288 extends SystemTestSpec{
    static final Logger LOGGER = LoggerFactory.getLogger(USB30_MAC_NV12_352x288.class)
    ...
    def "Format -- NV12_Resolution -- 352x288_Rate -- #rate" (Float rate) {
        ...
        whiteMac.startVideo("NV12", "352x288", (int) rate)
        sleep(5000)
        ...
        where:
        rate << whiteMac.getSupportedFrameRates( "NV12", "352x288")
    }
}
