...
@Title ("USB30_WIN_YUY2_640x360")
class USB30_WIN_YUY2_640x360 extends SystemTestSpec{
    static final Logger LOGGER = LoggerFactory.getLogger(USB30_WIN_YUY2_640x360.class)
...
//        whiteMac.select()
    ...
    @Unroll
    def "Format -- YUY2_Resolution -- 640x360_Rate -- #rate" (Float rate) {
        when:
