...
@Title ("USB30_WIN_YUY2_800x600")
class USB30_WIN_YUY2_800x600 extends SystemTestSpec{
    static final Logger LOGGER = LoggerFactory.getLogger(USB30_WIN_YUY2_800x600.class)
...
//        whiteMac.select()
    ...
    @Unroll
    def "Format -- YUY2_Resolution -- 800x600_Rate -- #rate" (Float rate) {
        when:
