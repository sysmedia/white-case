...
@Title ("USB20_WIN_YUY2_480x270")
class USB20_WIN_YUY2_480x270 extends SystemTestSpec{
    static final Logger LOGGER = LoggerFactory.getLogger(USB20_WIN_YUY2_480x270.class)
...
//        whiteMac.select()
    ...
    @Unroll
    def "Format -- YUY2_Resolution -- 480x270_Rate -- #rate" (Float rate) {
        when:
