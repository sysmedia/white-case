...
@Title ("USB30_MAC_MJPEG_640x480")
class USB30_MAC_MJPEG_640x480 extends SystemTestSpec{
    static final Logger LOGGER = LoggerFactory.getLogger(USB30_MAC_MJPEG_640x480.class)
    ...
    def "Format -- MJPEG_Resolution -- 640x480_Rate -- #rate" (Float rate) {
        ...
        where:
        rate << whiteMac.getSupportedFrameRates( "MJPG", "640x480")
    }
}
