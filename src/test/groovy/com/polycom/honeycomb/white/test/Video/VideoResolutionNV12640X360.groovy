...
@Title(" VideoResolutionNV12640x360 Case")
class VideoResolutionNV12640X360 extends SystemTestSpec{
    static final Logger LOGGER = LoggerFactory.getLogger(VideoResolutionNV12640X360.class)
    static int index = -1
    ...
    def "Format -- NV12_Resolution -- 640x360_Rate -- #rate" (Float rate) {
        ...
        white.startVideo("NV12", "640x360", (int) rate)
        sleep(5000)
        ...
        where:
        rate << white.getSupportedFrameRates("NV12", "640x360")
