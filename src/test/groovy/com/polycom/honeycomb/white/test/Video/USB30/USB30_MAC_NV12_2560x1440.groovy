...
@Title ("USB30_MAC_NV12_2560x1440")
class USB30_MAC_NV12_2560x1440 extends SystemTestSpec{
    static final Logger LOGGER = LoggerFactory.getLogger(USB30_MAC_NV12_2560x1440.class)
    ...
    def "Format -- NV12_Resolution -- 2560x1440_Rate -- #rate" (Float rate) {
        ...
        whiteMac.startVideo("NV12", "2560x1440", (int) rate)
        sleep(5000)
        ...
        where:
        rate << whiteMac.getSupportedFrameRates( "NV12", "2560x1440")
    }
}
