...
@Title ("USB30_WIN_MJPEG_480x270")
class USB30_WIN_MJPEG_480x270 extends SystemTestSpec{
    static final Logger LOGGER = LoggerFactory.getLogger(USB30_WIN_MJPEG_480x270.class)
