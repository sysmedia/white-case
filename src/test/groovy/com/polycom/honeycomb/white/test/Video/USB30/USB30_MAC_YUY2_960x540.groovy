...
@Title ("USB30_MAC_YUY2_960x540")
class USB30_MAC_YUY2_960x540 extends SystemTestSpec{
    static final Logger LOGGER = LoggerFactory.getLogger(USB30_MAC_YUY2_960x540.class)
    ...
    @Unroll
    def "Format -- YUY2_Resolution -- 960x540_Rate -- #rate" (Float rate) {
        when:
        ...
        where:
        rate << whiteMac.getSupportedFrameRates( "YUY2", "960x540")
    }
}
