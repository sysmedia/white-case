...
@Title ("USB30_WIN_MJPEG_1920x1080")
class USB30_WIN_MJPEG_1920x1080 extends SystemTestSpec{
    static final Logger LOGGER = LoggerFactory.getLogger(USB30_WIN_MJPEG_1920x1080.class)
