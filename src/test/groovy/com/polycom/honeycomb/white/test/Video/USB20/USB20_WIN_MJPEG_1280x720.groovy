...
@Title ("USB20_WIN_MJPEG_1280x720")
class USB20_WIN_MJPEG_1280x720 extends SystemTestSpec{
    static final Logger LOGGER = LoggerFactory.getLogger(USB20_WIN_MJPEG_1280x720.class)
