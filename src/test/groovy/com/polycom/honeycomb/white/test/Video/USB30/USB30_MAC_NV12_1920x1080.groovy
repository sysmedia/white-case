...
@Title ("USB30_MAC_NV12_1920x1080")
class USB30_MAC_NV12_1920x1080 extends SystemTestSpec{
    static final Logger LOGGER = LoggerFactory.getLogger(USB30_MAC_NV12_1920x1080.class)
    ...
    def "Format -- NV12_Resolution -- 1920x1080_Rate -- #rate" (Float rate) {
        ...
        whiteMac.startVideo("NV12", "1920x1080", (int) rate)
        sleep(5000)
        ...
        where:
        rate << whiteMac.getSupportedFrameRates( "NV12", "1920x1080")
    }
}
