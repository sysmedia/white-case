...
@Title("NVideoResolutionNV12800x600 case")
class VideoResolutionNV12800X600 extends SystemTestSpec{
    static final Logger LOGGER = LoggerFactory.getLogger(VideoResolutionNV12800X600.class)
    static int index = -1
 //   static final String whiteName = "Polycom White Video"
    ...
    def "Format -- NV12_Resolution -- 800x600_Rate -- #rate" (Float rate) {
        ...
        white.startVideo("NV12", "800x600", (int) rate)
        sleep(5000)
        ...
        where:
        rate << white.getSupportedFrameRates("NV12", "800x600")
