...
@Title ("USB30_WIN_MJPEG_1280x720")
class USB30_WIN_MJPEG_1280x720 extends SystemTestSpec{
    static final Logger LOGGER = LoggerFactory.getLogger(USB30_WIN_MJPEG_1280x720.class)
