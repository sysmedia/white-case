...
//@CollectSutLog
@Performance
class PerformanceRPDMacLongCall extends SystemTestSpec{
    private static final Logger logger = LoggerFactory.getLogger(PerformanceRPDMacLongCall.class)
    ...
    def "RPD Mac Long Call"() {
        ...
        1.upto(144) {
            ...
            if (rpdmac.getCallStatus() == 'RPDDisconnected') {
