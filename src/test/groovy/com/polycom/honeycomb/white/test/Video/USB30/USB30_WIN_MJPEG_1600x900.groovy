...
@Title ("USB30_WIN_MJPEG_1600x900")
class USB30_WIN_MJPEG_1600x900 extends SystemTestSpec{
    static final Logger LOGGER = LoggerFactory.getLogger(USB30_WIN_MJPEG_1600x900.class)
