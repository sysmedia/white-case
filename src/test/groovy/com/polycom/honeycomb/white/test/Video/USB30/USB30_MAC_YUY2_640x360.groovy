...
@Title ("USB30_MAC_YUY2_640x360")
class USB30_MAC_YUY2_640x360 extends SystemTestSpec{
    static final Logger LOGGER = LoggerFactory.getLogger(USB30_MAC_YUY2_640x360.class)
    ...
    def "Format -- YUY2_Resolution -- 640x360_Rate -- #rate" (Float rate) {
        ...
        where:
        rate << whiteMac.getSupportedFrameRates( "YUY2", "640x360")
    }
}
