...
@Title ("USB30_WIN_MJPEG_800x600")
class USB30_WIN_MJPEG_800x600 extends SystemTestSpec{
    static final Logger LOGGER = LoggerFactory.getLogger(USB30_WIN_MJPEG_800x600.class)
