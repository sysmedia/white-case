...
@Title ("USB30_WIN_YUY2_1600x900")
class USB30_WIN_YUY2_1600x900 extends SystemTestSpec{
    static final Logger LOGGER = LoggerFactory.getLogger(USB30_WIN_YUY2_1600x900.class)
...
//        whiteMac.select()
    ...
    @Unroll
    def "Format -- YUY2_Resolution -- 1600x900_Rate -- #rate" (Float rate) {
        when:
