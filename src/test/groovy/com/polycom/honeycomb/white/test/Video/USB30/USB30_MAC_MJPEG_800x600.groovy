...
@Title ("USB30_MAC_MJPEG_800x600")
class USB30_MAC_MJPEG_800x600 extends SystemTestSpec{
    static final Logger LOGGER = LoggerFactory.getLogger(USB30_MAC_MJPEG_800x600.class)
    ...
    def "Format -- MJPEG_Resolution -- 800x600_Rate -- #rate" (Float rate) {
        ...
        where:
        rate << whiteMac.getSupportedFrameRates( "MJPG", "800x600")
    }
}
