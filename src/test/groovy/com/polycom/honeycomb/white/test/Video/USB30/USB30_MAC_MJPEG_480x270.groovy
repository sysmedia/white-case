...
@Title ("USB30_MAC_MJPEG_480x270")
class USB30_MAC_MJPEG_480x270 extends SystemTestSpec{
    static final Logger LOGGER = LoggerFactory.getLogger(USB30_MAC_MJPEG_480x270.class)
    ...
    def "Format -- MJPEG_Resolution -- 480x270_Rate -- #rate" (Float rate) {
        ...
        where:
        rate << whiteMac.getSupportedFrameRates( "MJPG", "480x270")
    }
}
