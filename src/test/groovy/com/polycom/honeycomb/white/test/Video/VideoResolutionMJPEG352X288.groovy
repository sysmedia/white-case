...
@Title ("VideoResolutionMJPEG352X288")
class VideoResolutionMJPEG352X288 extends SystemTestSpec{
    static final Logger LOGGER = LoggerFactory.getLogger(VideoResolutionMJPEG352X288.class)
    ...
    def "Format -- MJPEG_Resolution -- 352x288_Rate -- #rate" (Float rate) {
        ...
        whiteWin.startVideo("MJPG", "352x288", (int) rate)
        ...
        where:
        rate << whiteWin.getSupportedFrameRates( "MJPG", "352x288")
    }
}
