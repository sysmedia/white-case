...
@Title ("USB30_WIN_MJPEG_2560x1440")
class USB30_WIN_MJPEG_2560x1440 extends SystemTestSpec{
    static final Logger LOGGER = LoggerFactory.getLogger(USB30_WIN_MJPEG_2560x1440.class)
