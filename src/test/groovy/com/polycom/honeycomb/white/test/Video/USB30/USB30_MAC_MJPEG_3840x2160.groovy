...
@Title ("USB30_MAC_MJPEG_3840x2160")
class USB30_MAC_MJPEG_3840x2160 extends SystemTestSpec{
    static final Logger LOGGER = LoggerFactory.getLogger(USB30_MAC_MJPEG_3840x2160.class)
    ...
    def "Format -- MJPEG_Resolution -- 3840x2160_Rate -- #rate" (Float rate) {
        ...
        where:
        rate << whiteMac.getSupportedFrameRates( "MJPG", "3840x2160")
    }
}
