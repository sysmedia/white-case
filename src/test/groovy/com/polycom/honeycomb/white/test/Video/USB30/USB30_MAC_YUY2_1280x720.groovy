...
@Title ("USB30_MAC_YUY2_1280x720")
class USB30_MAC_YUY2_1280x720 extends SystemTestSpec{
    static final Logger LOGGER = LoggerFactory.getLogger(USB30_MAC_YUY2_1280x720.class)
    ...
    def "Format -- YUY2_Resolution -- 1280x720_Rate -- #rate" (Float rate) {
        ...
        where:
        rate << whiteMac.getSupportedFrameRates( "YUY2", "1280x720")
    }
}
