...
@Title ("USB30_MAC_MJPEG_1280x720")
class USB30_MAC_MJPEG_1280x720 extends SystemTestSpec{
    static final Logger LOGGER = LoggerFactory.getLogger(USB30_MAC_MJPEG_1280x720.class)
    ...
    def "Format -- MJPEG_Resolution -- 1280x720_Rate -- #rate" (Float rate) {
        ...
        where:
        rate << whiteMac.getSupportedFrameRates( "MJPG", "1280x720")
    }
}
