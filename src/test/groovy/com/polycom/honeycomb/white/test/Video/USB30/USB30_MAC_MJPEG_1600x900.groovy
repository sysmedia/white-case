...
@Title ("USB30_MAC_MJPEG_1600x900")
class USB30_MAC_MJPEG_1600x900 extends SystemTestSpec{
    static final Logger LOGGER = LoggerFactory.getLogger(USB30_MAC_MJPEG_1600x900.class)
    ...
    def "Format -- MJPEG_Resolution -- 1600x900_Rate -- #rate" (Float rate) {
        ...
        where:
        rate << whiteMac.getSupportedFrameRates( "MJPG", "1600x900")
    }
}
