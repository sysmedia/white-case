...
@Title ("USB30_MAC_YUY2_1600x900")
class USB30_MAC_YUY2_1600x900 extends SystemTestSpec{
    static final Logger LOGGER = LoggerFactory.getLogger(USB30_MAC_YUY2_1600x900.class)
    ...
    def "Format -- YUY2_Resolution -- 1600x900_Rate -- #rate" (Float rate) {
        ...
        where:
        rate << whiteMac.getSupportedFrameRates( "YUY2", "1600x900")
    }
}
