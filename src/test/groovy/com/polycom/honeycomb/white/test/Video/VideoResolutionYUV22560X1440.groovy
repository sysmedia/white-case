...
@Title ("VideoResolutionYUV2G2560X1440")
class VideoResolutionYUV22560X1440 extends SystemTestSpec{
    static final Logger LOGGER = LoggerFactory.getLogger(VideoResolutionYUV22560X1440.class)
    ...
    def "Format -- MJPEG_Resolution -- 2560x1440_Rate -- #rate" (Float rate) {
        ...
        whiteWin.startVideo("YUY2", "2560x1440", (int) rate)
        ...
        where:
        rate << whiteWin.getSupportedFrameRates( "YUY2", "2560x1440")
    }
}