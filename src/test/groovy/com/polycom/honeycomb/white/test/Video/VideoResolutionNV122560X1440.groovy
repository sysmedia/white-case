...
@Title ("VideoResolutionNV122560X1440 Case")
class VideoResolutionNV122560X1440 extends SystemTestSpec{
    static final Logger LOGGER = LoggerFactory.getLogger(VideoResolutionNV122560X1440.class)
    static int index = -1
    ...
    @Unroll
    def "Format -- NV12_Resolution -- 2560x1440_Rate -- #rate" (Float rate) {
        when:
        LOGGER.info(String.format("Start White by rate %.1f",rate))
        white.startVideo("NV12", "2560x1440", (int) rate)
        sleep(5000)
        ...
        where:
        rate << white.getSupportedFrameRates("NV12", "2560x1440")
