...
@Title ("USB30_MAC_YUY2_640x480")
class USB30_MAC_YUY2_640x480 extends SystemTestSpec{
    static final Logger LOGGER = LoggerFactory.getLogger(USB30_MAC_YUY2_640x480.class)
    ...
    def "Format -- YUY2_Resolution -- 640x480_Rate -- #rate" (Float rate) {
        ...
        where:
        rate << whiteMac.getSupportedFrameRates( "YUY2", "640x480")
    }
}
