...
@Title ("USB30_WIN_YUY2_352x288")
class USB30_WIN_YUY2_352x288 extends SystemTestSpec{
    static final Logger LOGGER = LoggerFactory.getLogger(USB30_WIN_YUY2_352x288.class)
