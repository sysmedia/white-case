...
@Title ("USB30_WIN_MJPEG_960x540")
class USB30_WIN_MJPEG_960x540 extends SystemTestSpec{
    static final Logger LOGGER = LoggerFactory.getLogger(USB30_WIN_MJPEG_960x540.class)
