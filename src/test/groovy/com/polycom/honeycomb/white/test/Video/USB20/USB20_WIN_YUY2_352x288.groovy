...
@Title ("USB20_WIN_YUY2_352x288")
class USB20_WIN_YUY2_352x288 extends SystemTestSpec{
    static final Logger LOGGER = LoggerFactory.getLogger(USB20_WIN_YUY2_352x288.class)
...
//        whiteMac.select()
    ...
    @Unroll
    def "Format -- YUY2_Resolution -- 352x288_Rate -- #rate" (Float rate) {
        when:
