...
@Title ("USB30_WIN_MJPEG_3840x2160")
class USB30_WIN_MJPEG_3840x2160 extends SystemTestSpec{
    static final Logger LOGGER = LoggerFactory.getLogger(USB30_WIN_MJPEG_3840x2160.class)
