...
@Title ("USB30_WIN_YUY2_1024x576")
class USB30_WIN_YUY2_1024x576 extends SystemTestSpec{
    static final Logger LOGGER = LoggerFactory.getLogger(USB30_WIN_YUY2_1024x576.class)
...
//        whiteMac.select()
    ...
    @Unroll
    def "Format -- YUY2_Resolution -- 1024x576_Rate -- #rate" (Float rate) {
        when:
