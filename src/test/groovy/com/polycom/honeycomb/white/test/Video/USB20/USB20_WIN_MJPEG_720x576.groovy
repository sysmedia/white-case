...
@Title ("USB20_WIN_MJPEG_720x576")
class USB20_WIN_MJPEG_720x576 extends SystemTestSpec{
    static final Logger LOGGER = LoggerFactory.getLogger(USB20_WIN_MJPEG_720x576.class)
