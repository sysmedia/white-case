...
@Title ("USB30_MAC_YUY2_480x270")
class USB30_MAC_YUY2_480x270 extends SystemTestSpec{
    static final Logger LOGGER = LoggerFactory.getLogger(USB30_MAC_YUY2_480x270.class)
    ...
    def "Format -- YUY2_Resolution -- 480x270_Rate -- #rate" (Float rate) {
        ...
        where:
        rate << whiteMac.getSupportedFrameRates( "YUY2", "480x270")
    }
}
