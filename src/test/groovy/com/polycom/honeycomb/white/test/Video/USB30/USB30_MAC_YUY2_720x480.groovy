...
@Title ("USB30_MAC_YUY2_720x480")
class USB30_MAC_YUY2_720x480 extends SystemTestSpec{
    static final Logger LOGGER = LoggerFactory.getLogger(USB30_MAC_YUY2_720x480.class)
    ...
    @Unroll
    def "Format -- YUY2_Resolution -- 720x480_Rate -- #rate" (Float rate) {
        when:
        ...
        where:
        rate << whiteMac.getSupportedFrameRates( "YUY2", "720x480")
    }
}
