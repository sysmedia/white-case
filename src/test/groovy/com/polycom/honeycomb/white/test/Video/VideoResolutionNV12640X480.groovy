...
@Title(" VideoResolutionNV12640x480 Case")
class VideoResolutionNV12640X480 extends SystemTestSpec{
    static final Logger LOGGER = LoggerFactory.getLogger(VideoResolutionNV12640X480.class)
    static int index = -1
    ...
    def "Format -- NV12_Resolution -- 640x480_Rate -- #rate" (Float rate) {
        ...
        white.startVideo("NV12", "640x480", (int) rate)
        sleep(5000)
        ...
        where:
        rate << white.getSupportedFrameRates("NV12", "640x480")
