...
@Title ("VideoResolutionNV121280X720 Case")
class VideoResolutionNV121280X720 extends SystemTestSpec{
    static final Logger LOGGER = LoggerFactory.getLogger(VideoResolutionNV121280X720.class)
    static int index = -1
  //  static final String whiteName = "Polycom White Video"
    ...
    @Unroll
    def "Format -- NV12_Resolution -- 1280x720_Rate -- #rate" (Float rate) {
        when:
        LOGGER.info(String.format("Start White by rate %.1f",rate))
        white.startVideo("NV12", "1280x720", (int) rate)
        sleep(5000)
        ...
        where:
        rate << white.getSupportedFrameRates("NV12", "1280x720")
