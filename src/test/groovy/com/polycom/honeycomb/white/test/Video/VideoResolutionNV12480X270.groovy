...
@Title("VideoResolutionNV12480x270 case")
class VideoResolutionNV12480X270 extends SystemTestSpec{
    static final Logger LOGGER = LoggerFactory.getLogger(VideoResolutionNV12480X270.class)
    static int index = -1
    ...
    def "Format -- NV12_Resolution -- 480x270_Rate -- #rate" (Float rate) {
        ...
        white.startVideo("NV12", "480x270", (int) rate)
        sleep(5000)
        ...
        where:
        rate << white.getSupportedFrameRates("NV12", "480x270")
