...
@Title ("VideoResolutionMJPEG1920X1080")
class VideoResolutionMJPEG1920X1080 extends SystemTestSpec{
    static final Logger LOGGER = LoggerFactory.getLogger(VideoResolutionMJPEG1920X1080.class)
    ...
    def "Format -- MJPEG_Resolution -- 1920x1080_Rate -- #rate" (Float rate) {
        ...
        whiteWin.startVideo("MJPG", "1920x1080", (int) rate)
        ...
        where:
        rate << whiteWin.getSupportedFrameRates( "MJPG", "1920x1080")
    }
}