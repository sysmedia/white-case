...
@Title ("USB30_MAC_NV12_1280x720")
class USB30_MAC_NV12_1280x720 extends SystemTestSpec{
    static final Logger LOGGER = LoggerFactory.getLogger(USB30_MAC_NV12_1280x720.class)
    ...
    def "Format -- NV12_Resolution -- 1280x720_Rate -- #rate" (Float rate) {
        ...
        whiteMac.startVideo("NV12", "1280x720", (int) rate)
        sleep(5000)
        ...
        where:
        rate << whiteMac.getSupportedFrameRates( "NV12", "1280x720")
    }
}
