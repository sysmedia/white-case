...
@Title ("USB20_WIN_MJPEG_480x270")
class USB20_WIN_MJPEG_480x270 extends SystemTestSpec{
    static final Logger LOGGER = LoggerFactory.getLogger(USB20_WIN_MJPEG_480x270.class)
