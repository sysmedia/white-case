...
@Title ("VideoResolutionNV121600X900 Case")
class VideoResolutionNV121600X900 extends SystemTestSpec{
    static final Logger LOGGER = LoggerFactory.getLogger(VideoResolutionNV121600X900.class)
    static int index = -1
    ...
    def "Format -- NV12_Resolution -- 1600x900_Rate -- #rate" (Float rate) {
        ...
        white.startVideo("NV12", "1600x900", (int) rate)
        sleep(5000)
        ...
        where:
        rate << white.getSupportedFrameRates("NV12", "1600x900")
