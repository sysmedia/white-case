...
@Title ("USB30_WIN_YUY2_640x480")
class USB30_WIN_YUY2_640x480 extends SystemTestSpec{
    static final Logger LOGGER = LoggerFactory.getLogger(USB30_WIN_YUY2_640x480.class)
...
//        whiteMac.select()
    ...
    @Unroll
    def "Format -- YUY2_Resolution -- 640x480_Rate -- #rate" (Float rate) {
        when:
