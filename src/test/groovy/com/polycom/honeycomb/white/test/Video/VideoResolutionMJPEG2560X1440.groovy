...
@Title ("VideoResolutionMJPEG2560X1440")
class VideoResolutionMJPEG2560X1440 extends SystemTestSpec{
    static final Logger LOGGER = LoggerFactory.getLogger(VideoResolutionMJPEG2560X1440.class)
    ...
    @Unroll
    def "Format -- MJPEG_Resolution -- 2560x1440_Rate -- #rate" (Float rate) {
        when:
        LOGGER.info(String.format("Start White by rate %.1f", rate))
        whiteWin.startVideo("MJPG", "2560x1440", (int) rate)
        whiteMac.startVideo("MJPG", "2560x1440", (int) rate)
        sleep(5000)
